            ...
            >
              <div className={`flex items-center ${idx == 1 && "md:order-2"} justify-center h-full`}>
                <div>
                  <img
                    src={Triangle}
                    alt="Icon"
                    className={`mb-8 ${idx == 0 ? "event_one" : ""} ${idx == 2 ? "event_two" : ""} ${
                      idx == 1 ? "event" : ""
                    } h-12 w-auto`}
                  />
                  <span
                  ...
                  <div className="pl-6">
                    <ul className="list-disc text-secondary space-y-2 md:text-base lg:text-lg max-w-[300px]">
                      {items.options.map((item, index) => {
                        return (
                          <li
                            className={`${idx == 0 ? "event_one" : ""} ${idx == 2 ? "event_two" : ""} ${
                              idx == 1 ? "event" : ""
                            }`}
                            key={index}
                          >
                  ...
                  <Link
                    ...
                    className={`text-[#2E1B52] ${idx == 0 ? "event_one" : ""} ${idx == 2 ? "event_two" : ""} ${
                      idx == 1 ? "event" : ""
                    } w-fit flex items-center gap-2 px-8 py-4 rounded-full bg-[#F3F3F3] mt-10 hover:bg-[#4E2E8D] hover:text-white transition-colors ease-linear duration-300`}
                  >
              ...
              <div
                className={`rounded-3xl ${idx == 0 ? "event_one" : ""} ${
                  ...
                  idx == 1 ? "event md:order-1 gradient_bg" : "gradient_bg_one"

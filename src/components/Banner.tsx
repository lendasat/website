...
export const Banner = () => {
    ...
    return (
        <section className='min-h-screen flex items-center justify-center bg-blue-100 pt-30 px-4 pb-4'>
            <div
                className="w-[95vw] h-[95vh] border-purple-200 rounded-3xl flex items-center justify-center bg-opacity-95 shadow-lg">
                <div className="text-center max-w-4xl w-full mx-auto p-4">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
                        ...
                        <Link to="https://whitepaper.lendasat.com/lendasat-whitepaper.pdf" target="_blank"

...
export default function Payouts() {
  ...
  return (
    <section>
      <div className="grid items-center md:grid-cols-2 gap-10 md:gap-5 w-full max-w-6xl">
        ...
        <div className="flex items-center justify-center h-full pt-20 pb-32">
          <div>
            ...
            <Link
              to="#subscribe"
              className="text-white pay hover:bg-black transition-colors ease-linear duration-300 flex items-center gap-2 px-8 py-4 rounded-full bg-primary mt-10 w-fit"
            >
